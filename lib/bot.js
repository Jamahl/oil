...
const LIVE_SAFE = { positionSize: 1, minConfidence: 'Strong', dailyLossCap: 50, maxOpenTrades: 2 };
...
function switchEnv(env) {
  if (state.running) throw new Error('stop the bot before switching accounts');
  save();
